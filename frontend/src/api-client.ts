...
export const fetchCurrentUser = async (): Promise<UserType> => {
    return apiFetch<UserType>(`${API_BASE_URL}/api/users/me`, { credentials: "include" });
};
...
export const validateToken = async (): Promise<UserType> => {
    return apiFetch<UserType>(`${API_BASE_URL}/api/auth/validate-token`, { credentials: "include" });
};
...
export const fetchMyHotels = async (): Promise<HotelType[]> => {
    return apiFetch<HotelType[]>(`${API_BASE_URL}/api/my-hotels`, { credentials: "include" });
};

// Fetch a hotel by ID
export const fetchMyHotelById = async (hotelId: string): Promise<HotelType> => {
    return apiFetch<HotelType>(`${API_BASE_URL}/api/my-hotels/${hotelId}`, { credentials: "include" });
};
