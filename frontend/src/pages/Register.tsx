  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <input className="border rounded w-full py-1 none  font-normal" {...register("firstName",{required: "This field is required"})} type="text" />
        {errors.firstName && (
      ...
      <label className="text-gray-700 text-sm font-bold flex-1">Email
        ...
        <input className="border rounded w-full py-1 px-2  font-normal" {...register("password",{required: "This field is required", minLength: {value: 6, message: "Password must be atleast 6 characters"}})} type="password" />
        {errors.password && (
        ...
        <span>
          <button type="submit" className="bg-gray-600 text-white p-2 font-bold hover:bg-gray-500 text-xl">Create Account</button>
        </span>
    </form>
  )
}
